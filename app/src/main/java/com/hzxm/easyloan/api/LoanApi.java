...
public interface LoanApi {
    ...
    //社保地址
    @FormUrlEncoded
    @POST("Metioninfo/socal_area.html")
    Observable<SocialCityModel> socialArea(
            @Field("time") String time,
            @Field("hash") String hash,
            @Field("uid") String uid
    );
    ...
    //社保查询
    @FormUrlEncoded
    @POST("Metioninfo/socal_search.html")
    Observable<SocialSecurityModel> socialSecurity(
            @Field("time") String time,
            @Field("hash") String hash,
            @Field("uid") String uid,
    ...
    //社保结果
    @FormUrlEncoded
    @POST("Metioninfo/socal_result.html")
    Observable<BaseModel> socialResult(
            @Field("time") String time,
            @Field("hash") String hash,
            @Field("uid") String uid,
            @Field("token") String area,
            @Field("username") String username,
            @Field("password") String password
    );
}
