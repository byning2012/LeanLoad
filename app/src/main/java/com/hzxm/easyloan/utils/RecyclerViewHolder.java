...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerViewHolder(Context context, View headerView) {
        super(headerView);
        mContext = context;
        mConvertView = headerView;
        mViews = new SparseArray<>();
        mConvertView.setTag(this);
    }
    ...
    public RecyclerViewHolder setImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        GliderHelper.loadImage(url, view, null);
        return this;
    }

    public RecyclerViewHolder setBigImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
      //  GliderHelper.displayBigPhoto(mContext, view, url);
        return this;
    }

    public RecyclerViewHolder setSmallImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
   //     GliderHelper.displaySmallPhoto(mContext, view, url);
        return this;
    }

    public RecyclerViewHolder setImageRoundUrl(int viewId, String url) {
        ImageView view = getView(viewId);
    //    GliderHelper.displayRound(mContext, view, url);
        return this;
    }

    public RecyclerViewHolder setImageFile(int viewId, File url) {
        ImageView view = getView(viewId);
    //    GliderHelper.display(mContext, view, url);
        return this;
    }
