...
public class BankCardPresenter extends BasePresenterImpl implements
    ...
    public void deleteCard(String id) {
        Subscription s = ApiManager.getInstance().getLoanApiService().deleteBankCard(System.currentTimeMillis() + "", "39a851a7218472226ece36d1377f3cf0"
                , id)
                .subscribeOn(Schedulers.io())
                .doOnSubscribe(new Action0() {
                    @Override
                ...
                .subscribe(new Subscriber<BaseModel>() {
                    ...
                    public void onNext(BaseModel baseModel) {
                        ...
                        if (baseModel.getCode() == 0) {
                            mIBankCardManagerView.deleteSuccess();
                        } else {
                            mIBankCardManagerView.showError(baseModel.getMsg());
                        }
