...
public class PropertyAndCardActivity extends BaseActivity implements IPropertyAndCarView,
    ...
    private WeakReference<PropertyAndCardActivity> mActivity = new WeakReference<>(this);
    @BindView(R.id.title)
    TitleLayout title;
        ...
        public DocumentPopupWindow(Context mContext, View parent) {
            ...
            view.findViewById(R.id.tv_photo).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    GalleryFinal.openGallerySingle(Constant.REQUEST_CODE_GALLERY, mActivity.get());
                    popupWindow.dismiss();
                }
            });
            view.findViewById(R.id.tv_camera).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    GalleryFinal.openCamera(Constant.REQUEST_CODE_CAMERA, mActivity.get());
                    popupWindow.dismiss();
                }
            });
