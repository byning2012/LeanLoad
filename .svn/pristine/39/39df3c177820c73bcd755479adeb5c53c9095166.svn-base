...
public class TitleLayout extends RelativeLayout {
    private RelativeLayout mrl_bg_color;
    /**
     * 标题栏返回按钮
     */
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        boolean isWhite = typedArray.getBoolean(R.styleable.TitleLayout_titlelayout_style, false);
        View view;
        if (isWhite) {
            view = LayoutInflater.from(context).inflate(
                    R.layout.multip_global_title_white,
                    this,
                    true
            );
        } else {
        ...
        if (view != null) {
            ...
            mrl_bg_color = (RelativeLayout) findViewById(R.id.rl_bg_color);
            if (title != null) {
                setTitle(title);
            }
    ...
    public void setWhiteStyle(Context context) {
        mrl_bg_color.setBackgroundColor(context.getResources().getColor(R.color.white));
        titleText.setTextColor(context.getResources().getColor(R.color.home_blue));
        backButton.setImageDrawable(context.getResources().getDrawable(R.drawable.back));
    }
