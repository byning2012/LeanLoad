...
import com.lmz.baselibrary.util.ScreenUtil;
...
//        //对应xml中的containerId
//        navigateTabBar.setFrameLayoutId(R.id.main_container);<---布局文件上方FramLayout的 id ;
...
public class TabStripView extends LinearLayout implements View.OnClickListener {
    ...
    public TabStripView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : ContextCompat.getColorStateList(context, R.color.abc_tab_text_normal));
